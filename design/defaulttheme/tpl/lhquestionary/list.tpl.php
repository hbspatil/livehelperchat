<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('questionary/list','Ticket List');?></h1>
...
<a class="btn btn-default" href="<?php echo erLhcoreClassDesign::baseurl('questionary/newquestion')?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('questionary/list','New Ticket');?></a>
