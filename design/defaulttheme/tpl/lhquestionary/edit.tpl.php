<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('questionary/edit','Edit the Ticket');?> - <?php echo htmlspecialchars($question->question)?></h1>

<div role="tabpanel">
	<!-- Nav tabs -->
	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="<?php if ($tab == '') : ?>active<?php endif;?>"><a href="#panel1" aria-controls="panel1" role="tab" data-toggle="tab"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('questionary/edit','Ticket');?></a></li>
